...
export type SpinnerGapVariant = "duotone" | "fill" | "light";

export interface SpinnerGapProps extends SVGProps<SVGSVGElement> {
  variant?: SpinnerGapVariant;
  primaryColor?: string;
