...
export type UniteVariant = "duotone" | "fill" | "light";

export interface UniteProps extends SVGProps<SVGSVGElement> {
  variant?: UniteVariant;
  primaryColor?: string;
  secondaryColor?: string;
}

const FILL_INNER      = "<path d=\"M240,164a76,76,0,0,1-151.9,3.9,76,76,0,1,1,79.8-79.8A76.1,76.1,0,0,1,240,164Z\"/>";
...
const SECONDARY_PATHS = "<path d=\"M232,160a72,72,0,0,1-143.6,7.6,72,72,0,1,1,79.2-79.2A72,72,0,0,1,232,160Z\"/>";
