...
export type HourglassMediumVariant = "duotone" | "fill" | "light";

export interface HourglassMediumProps extends SVGProps<SVGSVGElement> {
  variant?: HourglassMediumVariant;
  primaryColor?: string;
...
const SECONDARY_PATHS = "<path d=\"M180.92,88,128,128,74.67,88Z\"/>";

export const HourglassMedium = ({
  variant = "duotone",
  primaryColor = "currentColor",
  secondaryColor,
  style,
  ...props
}: HourglassMediumProps) => {
