...
export type CloudXVariant = "duotone" | "fill" | "light";

export interface CloudXProps extends SVGProps<SVGSVGElement> {
  variant?: CloudXVariant;
  primaryColor?: string;
...
const SECONDARY_PATHS = "<path d=\"M240,127.62a80,80,0,0,1-80,80H72A56,56,0,1,1,85.92,97.36l0,.1A80,80,0,0,1,240,127.62Z\"/>";
