...
export type FileCodeVariant = "duotone" | "fill" | "light";

export interface FileCodeProps extends SVGProps<SVGSVGElement> {
  variant?: FileCodeVariant;
  primaryColor?: string;
