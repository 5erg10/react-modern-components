...
export type PhonePauseVariant = "duotone" | "fill" | "light";

export interface PhonePauseProps extends SVGProps<SVGSVGElement> {
  variant?: PhonePauseVariant;
  primaryColor?: string;
