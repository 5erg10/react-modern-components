...
const SECONDARY_PATHS = "<path d=\"M192,60a20,20,0,1,1-20-20A20,20,0,0,1,192,60Z\"/>";

export const PersonSimpleSki = ({
  variant = "duotone",
  primaryColor = "currentColor",
  secondaryColor,
  style,
  ...props
}: PersonSimpleSkiProps) => {
