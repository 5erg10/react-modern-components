...
export type FilePdfVariant = "duotone" | "fill" | "light";

export interface FilePdfProps extends SVGProps<SVGSVGElement> {
  variant?: FilePdfVariant;
  primaryColor?: string;
