...
export type AppStoreLogoVariant = "duotone" | "fill" | "light";

export interface AppStoreLogoProps extends SVGProps<SVGSVGElement> {
  variant?: AppStoreLogoVariant;
  primaryColor?: string;
...
const LIGHT_INNER     = "<path d=\"M62.62,195.05l-9.45,16A6,6,0,0,1,42.83,205l9.46-16a6,6,0,1,1,10.33,6.1ZM232,154H183.06l-31.31-53a6,6,0,1,0-10.33,6.11l61.41,103.93a6,6,0,0,0,10.34-6.1l-23-38.95H232a6,6,0,0,0,0-12Zm-89.53,0H86.88L157.17,35.05A6,6,0,0,0,146.83,29L128,60.82,109.17,29a6,6,0,0,0-10.34,6.1L121,72.62,72.94,154H24a6,6,0,0,0,0,12H142.47a6,6,0,1,0,0-12Z\"/>";
...
const SECONDARY_PATHS = "<path d=\"M179.64,160H76.36L128,72.62Z\"/>";
