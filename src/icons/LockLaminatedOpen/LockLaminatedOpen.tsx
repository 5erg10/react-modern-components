...
export const LockLaminatedOpen = ({
  variant = "duotone",
  primaryColor = "currentColor",
  secondaryColor,
  style,
  ...props
}: LockLaminatedOpenProps) => {
