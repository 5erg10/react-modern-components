...
export type PaintBucketVariant = "duotone" | "fill" | "light";

export interface PaintBucketProps extends SVGProps<SVGSVGElement> {
  variant?: PaintBucketVariant;
  primaryColor?: string;
...
const SECONDARY_PATHS = "<path d=\"M248,208a16,16,0,0,1-32,0c0-16,16-40,16-40S248,192,248,208Zm-16-76.52-24,8-79.83,79.83a16,16,0,0,1-22.63,0L20.69,134.46a16,16,0,0,1,0-22.63L116.52,16Zm-93.86-29.62a20,20,0,1,0,0,28.28A20,20,0,0,0,138.14,101.86Z\"/>";
